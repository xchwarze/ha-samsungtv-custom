...
Edit it by adding the following lines:
    ...
    **app_list:**<br/>
    ...
    You can also add at the end of every app ID and additional value (separated by "/") that indicate the channel name exposed by SmartThings. This will help identifing the running app if SmartThings API are enabled. This additional value is optional and if not present will be used the app ID to identify the running app.
    Example value: '{"Netflix": "11101200001/org.tizen.netflix-app", "YouTube": "111299001912/9Ur5IzDKqV.TizenYouTube", "Spotify": "3201606009684"}'<br/>
    ...
    **scan_app_ws:**<br/>
    (boolean)(Optional)<br/>
    Allow you to disable the scan of running app polling port 8001 of the TV to have the refresh of the TV status and app running faster.
    If the SmartThings API is enabled (by settings "api_key" and "device_id"), then this option is false by default and the scan is diabled. You can enable it setting the value to true. 
